...
import org.apache.parquet.hadoop.ParquetWriterBuilder
import org.apache.parquet.hadoop.api.WriteSupport
import org.apache.parquet.hadoop.api.WriteSupport.WriteContext
import org.apache.parquet.io.api.RecordConsumer
import org.apache.parquet.schema.{MessageType, MessageTypeParser}

private[write] class DirectWriteSupport(schema: MessageType, metadata: Map[String, String])
...
object DirectParquetWriter {
  class Builder(path: Path) extends ParquetWriterBuilder[RecordBuilder, Builder](path) {
